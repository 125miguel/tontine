...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bg-success-cell { background-color: #d4edda; }
        .bg-warning-cell { background-color: #fff3cd; }
        .bg-secondary-cell { background-color: #e2e3e5; }
        .bg-info-cell { background-color: #d1ecf1; }
